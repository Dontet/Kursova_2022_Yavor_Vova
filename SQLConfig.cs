...
namespace BakeryInventorySystem
{
    class SQLConfig
    {
        ...
        private OleDbConnection con = new OleDbConnection("Provider=Microsoft.JET.OLEDB.4.0;Data Source=" 
                                     + Application.StartupPath + "\\dbBakeshop.mdb; JET OLEDB:Database Password = admin1234");
